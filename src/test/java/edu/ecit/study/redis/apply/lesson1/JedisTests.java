...
public class JedisTests {
	private String redis_host = "120.78.64.193";
    // ------------------------ jedis 工具直连演示
    ...
    public void hashTest() {
        ...
        Jedis jedis = new Jedis(redis_host, 6379);
        jedis.hset("user_10001", "name", "hash");
    ...
    public void zsetTest() {
        ...
        jedis.zadd(ranksKeyName, 100.0, "redis");
        jedis.zadd(ranksKeyName, 82.0, "java");
        jedis.zadd(ranksKeyName, 90, "hash");
        jedis.zadd(ranksKeyName, 96, "map");
